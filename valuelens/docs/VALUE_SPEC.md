...
Canonical contract for a ValueLens workspace. Stored as `valuetree.yaml` at the workspace root.
...
Machine-readable schema: [`../schemas/valuetree.schema.json`](../schemas/valuetree.schema.json)

Sample: [`../samples/valuetree.sample.yaml`](../samples/valuetree.sample.yaml)
...
| ValueBet overlay | Out | Always OK — ValueLens-owned kind |
