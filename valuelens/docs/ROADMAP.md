...
- [x] ValueSpec schema + sample
- [x] Executive mockups
- [x] Feature PRDs
- [x] ADRs for stack, local-first, suite relationship
...
| ValueSpec persistence | [F09](./prds/F09-valuespec-persistence.md) |
...
- CI check action for ValueSpec mismatches
- Optional Backstage overlay `ValueBet` kind docs
