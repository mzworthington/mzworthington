...
**Slice:** 1 · **Mockup:** `valuelens-exec-07-evidence.png`
...
Show plain-language metric stories from sample/manual evidence; set expectations that live systems come later.
...
1. List metrics with large figures + one-line interpretation
2. Badge/copy: “Sample data · connect systems later”
3. CTA: Use in decision note (pre-fills `measured[]`)
