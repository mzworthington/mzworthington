...
**Slice:** 1 · **Mockup:** `valuelens-exec-05-workspace-home.png`
...
- As a Director, I can open a folder with `valuetree.yaml` so my real narrative persists on disk.
- As a Director, I understand that no account is required.

## Requirements

1. Primary CTA: **Open folder** (FS Access when available)
2. Secondary: **Start from sample** (loads `samples/valuetree.sample.yaml`)
...
- Given a valid folder, Open folder loads ValueSpec
