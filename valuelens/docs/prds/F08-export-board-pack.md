...
**Slice:** 1 · **Mockup:** `valuelens-exec-08-export.png`

## Problem

Distribution to leadership must not require giving everyone ValueLens access (especially pre-auth).
...
5. Filenames: `valuelens-board-pack-<workspace>-<date>.pdf`
