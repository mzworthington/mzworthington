...
SteerLens is a **steering workspace**: edit strategy and topology intent in plain language, persist a canonical **SteerSpec**, leave with decision notes, and export a board pack when you need to share. It reads and later writes *around* existing systems of record; it does not become one.
...
| Term | Definition |
|------|------------|
| **Outcome** | Measurable change the organisation wants (e.g. “Reliable customer promises”) |
